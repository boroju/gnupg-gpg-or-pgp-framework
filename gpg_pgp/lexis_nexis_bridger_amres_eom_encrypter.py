...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Python program for Lexis-Nexis Bridger AmRes EoM Encrypter by using Gnupg PGP.',
        add_help=True)
    ...
    parser.add_argument('-t', '--target_location', type=str, required=True, help='Encrypted files destination - e.g. "/mnt/loadstore/AmRes/Compliance/Bridger/EOM/encrypted"')
