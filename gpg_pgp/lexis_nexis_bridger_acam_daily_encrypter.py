...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Python program for Lexis-Nexis Bridger ACaM Daily Encrypter by using Gnupg PGP.',
        add_help=True)
    ...
    parser.add_argument('-t', '--target_location', type=str, required=True, help='Encrypted files destination - e.g. "/mnt/loadstore/ACAM/Compliance/Bridger/Daily/encrypted"')
    ...
    parser.add_argument('-p', '--filename_contains_pattern', type=str, required=True, help='Check if files contain proper name pattern - e.g. *File-Amherst*.txt')
